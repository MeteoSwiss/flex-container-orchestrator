"""
Note: This script from mchpy (MeteoSwiss Blueprint) was added here because I couldmchpyy from outside of the MeteoSwiss network.
...
class BaseServiceSettings(BaseSettings):
    ...
    def __init__(self, settings_file_names: str | list[str], settings_dirname: str, **values: Any):
        """
